...
map_modules:
	...
	.byte	0xb3, 0x8, 0x74, 0xfd, 0x53, 0x79, 0x6d, 0x4d, 0xb6, 0xa7, 0x63, 0x43, 0xda, 0xf4, 0xa8, 0x39	// module_uuid: fd7408b3-7953-4d6d-b6a7-6343daf4a839
	.word	0x2	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module22_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.22	// assembly_name: PuzzleVanGogh
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
	...
	.byte	0xf6, 0x63, 0xf2, 0x18, 0x67, 0x12, 0x12, 0x40, 0xbc, 0xc6, 0x78, 0xcd, 0xd1, 0x2f, 0x4f, 0x83	// module_uuid: 18f263f6-1267-4012-bcc6-78cdd12f4f83
	.word	0x1c7	// entry_count
	.word	0xad	// duplicate_count
...
map_java:
	...
	.word	0x2000009	// type_token_id
	.ascii	"crc64e861fa6a3b9655b0/MainActivity"	// java_name
	.zero	69	// byteCount == 34; fixedWidth == 103; returned size == 103
	.zero	1

	.word	0x16	// module_index
	.word	0x200000a	// type_token_id
	.ascii	"crc64e861fa6a3b9655b0/MainApplication"	// java_name
	.zero	66	// byteCount == 37; fixedWidth == 103; returned size == 103
	.zero	1
